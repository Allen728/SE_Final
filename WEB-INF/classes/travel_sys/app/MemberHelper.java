...
public class MemberHelper {
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `travel_saver`.`members` WHERE `email` = ?";
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `travel_saver`.`members`(`name`, `email`, `password`)"
                    + " VALUES(?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `travel_saver`.`members` SET `name` = ? ,`password` = ? WHERE `email` = ?";
            /** 取得所需之參數 */
            String name = m.getName();
            String email = m.getEmail();
            String password = m.getPassword();
    ...
    public JSONObject getByEmail(String email) {
        ...
        try {
            conn = DBMgr.getConnection();
            String sql = "SELECT * FROM `travel_saver`.`members` WHERE email = ? LIMIT 1";
            ...
            while(rs.next()) {
                ...
                /** 將每一筆會員資料產生一名新User物件 */
                m = new Member(id, name, user_email, password);
            }
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `travel_saver`.`members` WHERE id = ? LIMIT 1";
            ...
            while(rs.next()) {
                ...
                m = new Member(user_id, name, email, password);
            }
   ...
   public JSONObject deleteByID(int id) {
       ...
       try {
           ...
           /** SQL指令 */
           String sql = "DELETE FROM `travel_saver`.`members` WHERE id = ? LIMIT 1";
